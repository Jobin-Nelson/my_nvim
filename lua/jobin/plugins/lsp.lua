return {
  ...
  config = function()
    local on_attach = function(client, bufnr)
      ...
      nmap('<leader>ld', require('fzf-lua').diagnostics_document, 'Open diagnostic list')
      nmap('<leader>ls', require('fzf-lua').lsp_document_symbols, 'Lsp Document Symbols')
      nmap('<leader>lS', require('fzf-lua').lsp_live_workspace_symbols, 'Lsp Workspace Symbols')
