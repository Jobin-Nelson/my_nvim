...
vim.keymap.set('n', '<leader>fa', '<cmd>lua require("jobin.config.custom.pickers").find_config()<cr>', { desc = 'Find Config' })
vim.keymap.set('n', '<leader>fd', '<cmd>lua require("jobin.config.custom.pickers").find_dotfiles()<cr>', { desc = 'Find Dotfiles' })
vim.keymap.set('n', '<leader>fz', '<cmd>lua require("jobin.config.custom.pickers").find_zoxide()<cr>', { desc = 'Find Zoxide' })
vim.keymap.set('n', '<leader>fs', '<cmd>lua require("jobin.config.custom.pickers").find_second_brain_files()<cr>', { desc = 'Find Second brain files' })
vim.keymap.set('n', '<leader>fO', '<cmd>lua require("jobin.config.custom.pickers").find_org_files()<cr>', { desc = 'Find Org files' })
